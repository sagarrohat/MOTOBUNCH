...
import com.example.fyp.historyRecyclerView.HistoryAdapter;
import com.example.fyp.historyRecyclerView.HistoryObject;
...
public class HistoryActivity extends AppCompatActivity {
    ...
    private void getUserHistoryIds() {
        DatabaseReference userHistoryDatabase = FirebaseDatabase.getInstance("https://uberclone-e20d0-default-rtdb.firebaseio.com/").getReference().child("Users").child(customerOrDriver).child(userId).child("history");
